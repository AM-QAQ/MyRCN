                ...
                <div class="purchase-guide">
                    <div class="step-card">
                        ...
                        <div class="step-content">
                            <p>
                                在浏览器输入
                                <a href="https://dash.rw.der.kim" target="_blank"
                                    class="highlight-link">dash.rw.der.kim</a>进入登录界面
                            </p>
                    ...
                    <div class="step-card">
                        ...
                        <div class="step-content">
                            <p>
                                点击
                                <span class="highlight">注册账号</span>
                                ，进行账号注册，邮箱务必使用
                                <span class="highlight">QQ邮箱</span>
                            </p>
                    ...
                    <div class="step-card">
                        ...
                        <div class="step-content">
                            <p>
                                在左侧菜单栏选择<span class="highlight">服务->钱包->自助充值</span>，根据需要购买的套餐充值对应的金额：
                            </p>
                            <ul class="price-list">
                                <li>0.5r - 天</li>
                                <li>6r - 月</li>
                    ...
                    <div class="step-card">
                        ...
                        <div class="step-content">
                            ...
                            <div class="warning-text">
                                若微信不支持图片扫码支付，可使用手机扫码电脑上的二维码
                            </div>
                            <p>
                                充值完成后选择<span class="highlight">服务->购买服务</span>，购买需要的套餐
                            </p>
                            <div class="img-container">
                    ...
                    <div class="step-card">
                        ...
                        <div class="step-content">
                            <p>
                                购买成功后可在<span class="highlight">RCN-Pro -> 设置</span>中查看到期时间
                            </p>
                            <div class="img-container">
                        ...
                        <div class="method-content">
                            <div class="usage-step">
                                <div class="step-text">
                                    ...
                                    <p>
                                        在左侧菜单选择<span class="highlight">RCN-Pro->绑定</span>，确定"快速绑定/慢速绑定修改"为<span
                                            class="highlight">启用</span>
                                    </p>
                            ...
                            <div class="usage-step">
                                <div class="step-text">
                                    ...
                                    <p>
                                        登录游戏，在IP地址栏输入<span class="highlight">sssss</span>
                                    </p>
                                </div>
                                <div class="img-container">
                            ...
                            <div class="usage-step">
                                <div class="step-text">
                                    ...
                                    <p>
                                        在弹出的提示框中输入<span class="highlight">newup</span>，注意查看房间提示确定是否公开
                                    </p>
                                </div>
                                <div class="img-container">
                        ...
                        <div class="method-content">
                            ...
                            <div class="usage-step">
                                <div class="step-text">
                                    <span class="step-marker">2</span>
                                    <p>
                                        登录游戏在IP地址栏输入<span class="highlight">sssss</span>
                                    </p>
                                    <p>
                                        在弹窗中输入所复制的<span class="highlight">慢速绑定码</span>
                                    </p>
                                    <p>
                                        显示绑定成功后再输入<span class="highlight">newup</span>
                                    </p>
                                </div>
                                <div class="img-container">
                                    <img src="@/assets/img/pro/use-2.png" alt="图片加载失败" />
                            ...
                            <div class="usage-note">
                                ...
                                <p>
                                    慢速绑定最多绑定两个设备，若需要绑定新的设备请在<span class="highlight">RCN-Pro->绑定</span>删除无用的设备
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="faq-container">
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">
                            请试着在当前游戏设备上重新登录Pro网站或更换网络。若问题依旧，请联系管理员
                        </div>
                    </div>
